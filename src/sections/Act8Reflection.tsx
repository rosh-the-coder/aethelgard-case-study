...
export function Act8Reflection() {
  return (
    <>
      <ReflectionQuote>{act8.paragraphs[0]}</ReflectionQuote>

      <section className="section" id="act-8" aria-labelledby="act8-title">
        <div className="container container-narrow">
          <p className="eyebrow">{act8.eyebrow}</p>
          <h2 className="section-title" id="act8-title">
            {act8.title}
          </h2>
          <div className="prose">
